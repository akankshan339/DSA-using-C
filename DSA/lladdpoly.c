/* WACP to add of 2 polynomials of degree n, using linked list
eg p1 = first polynomial p1=an x^n + an-1 x^n-1 + an-2 x^n-2 + .........a0 x^0
p2 = second polynomial   P2=bn x^n + bn-1 x^n-1 + bn-2 x^n-2 +...........b0 x^0
Find out p3= p1+p2  */
#include <stdio.h>
#include <stdlib.h>
